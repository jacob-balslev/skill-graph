...
This is the rationale and deep explanation for the Skill Metadata Protocol. For normative authoring rules, start with [`skill-metadata-protocol/SKILL_METADATA_PROTOCOL.md`](SKILL_METADATA_PROTOCOL.md) (in this repo's root); this document explains why the protocol has this shape and how the pieces fit together.
