...
Any runtime that supports compaction without a pre-compact hook is *one accidental compaction away from losing the decision trail*. The hook is not optional infrastructure for any session that runs more than a few minutes.
