...
- Owned by `tool-call-flow`: the protocol cycle by which a model invokes external capabilities and receives results
...
- Owned by `api-design`: the external HTTP request/response surface
