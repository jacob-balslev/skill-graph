...
- Owned by `semantic-relations`: the typed connections between concepts (IS-A, PART-OF, thematic roles)
...
- Related: `linguistics`, `a11y`, `intent-recognition`, `visual-design-foundations`
