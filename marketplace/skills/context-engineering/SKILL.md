...
metadata:
  relations: "{\"adjacent\":[\"prioritization\",\"spec-driven-development\",\"task-path-optimization\"],\"boundary\":[\"prompt-craft\"]}"
  subject: agent-ops
...
**Related skills**
- Related: `prioritization`, `spec-driven-development`, `task-path-optimization`
