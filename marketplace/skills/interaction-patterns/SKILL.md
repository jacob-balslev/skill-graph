...
metadata:
  ...
  skill_graph_canonical_skill: skills/design-craft/interaction-patterns/SKILL.md
...
- Owned by `design-system-architecture`: reusable component APIs
- Owned by `design-module-composition`: component props, variants, slots, and token contracts
- Owned by `component-architecture`
- Owned by `spec-driven-development`: writing the user goal, top task, or spec BEFORE any design happens
