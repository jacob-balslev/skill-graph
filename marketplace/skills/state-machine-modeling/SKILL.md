...
metadata:
  relations: "{\"related\":[\"observability-modeling\",\"api-design\",\"debugging\",\"event-storming\",\"system-interface-contracts\",\"testing-strategy\",\"state-management\"],\"suppresses\":[\"event-storming\",\"entity-relationship-modeling\"],\"verify_with\":[\"system-interface-contracts\",\"testing-strategy\"]}"
