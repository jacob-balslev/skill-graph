...
metadata:
  relations: "{\"related\":[\"lint-overlay\",\"refactor\",\"naming-conventions\",\"diagnosis\",\"debugging\",\"code-review\"],\"verify_with\":[\"context-graph\",\"skill-infrastructure\",\"tool-call-strategy\"]}"
...
**Not for**
- review this code for semantic correctness
- find where the user-auth helper is defined
- design a MECE classification taxonomy for our error catalogue
...
- Related: `lint-overlay`, `refactor`, `naming-conventions`, `diagnosis`, `debugging`, `code-review`
