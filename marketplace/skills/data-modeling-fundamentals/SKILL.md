...
metadata:
  relations: "{\"related\":[\"conceptual-modeling\",\"entity-relationship-modeling\",\"entity-relationship-modeling\",\"schema-evolution\"],\"suppresses\":[\"schema-evolution\"],\"verify_with\":[\"entity-relationship-modeling\",\"entity-relationship-modeling\"]}"
  ...
  anti_examples: "[\"design the practical schema for a new persistence layer (use entity-relationship-modeling)\",\"apply an expand-contract migration to change an existing schema (use schema-evolution)\",\"choose which indexes to maintain (use indexing-strategy)\",\"discover business entities without implementation details (use conceptual-modeling)\"]"
  mental_model: "|"
  purpose: "|"
  concept_boundary: "|"
...
|---|---|---|
| Designing the practical schema for a new persistence layer | `entity-relationship-modeling` | entity-relationship-modeling owns the method; this owns the theory |
...
**Related skills**
- Verify with: `entity-relationship-modeling`
- Related: `conceptual-modeling`, `entity-relationship-modeling`, `schema-evolution`
