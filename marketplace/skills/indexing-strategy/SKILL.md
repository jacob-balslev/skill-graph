...
metadata:
  relations: "{\"related\":[\"transaction-isolation\",\"query-optimization\",\"entity-relationship-modeling\",\"schema-evolution\",\"connection-pooling\",\"database-migration\"],\"suppresses\":[\"query-optimization\",\"schema-evolution\",\"sharding-strategy\"],\"verify_with\":[\"entity-relationship-modeling\",\"query-optimization\",\"database-migration\"]}"
...
- choose a database schema (use entity-relationship-modeling)
- decide how to partition data across nodes (use sharding-strategy)

**Related skills**
- Verify with: `entity-relationship-modeling`, `query-optimization`, `database-migration`
