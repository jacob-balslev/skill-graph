...
- Owned by `data-modeling`: logical and physical data structures such as tables, columns, constraints, and persistence shape
...
- Related: `conceptual-modeling`, `ontology-modeling`, `taxonomy-design`, `semantic-relations`, `context-graph`, `context-engineering`, `skill-infrastructure`
