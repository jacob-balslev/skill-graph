...
- Owned by `design-module-composition`: how a SINGLE PRODUCT's modules compose internally — layout, slots, named regions, within-product composition patterns
- Owned by `visual-design-foundations`: the design language itself: color theory, typography, spacing, grid, motion

**Related skills**
- Verify with: `design-system-architecture`, `design-module-composition`
- Related: `design-system-architecture`, `design-module-composition`, `visual-design-foundations`, `state-management`, `frontend-architecture`, `typography-system`, `color-system-design`
