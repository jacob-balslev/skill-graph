...
metadata:
  relations: "{\"related\":[\"positioning\",\"swot-tows\",\"pestel\",\"porters-five-forces\",\"playing-to-win\",\"seven-powers\",\"blue-ocean-strategy\",\"expected-value\",\"epistemic-grounding\",\"methodology\"],\"suppresses\":[\"swot-tows\",\"expected-value\",\"pestel\",\"porters-five-forces\",\"playing-to-win\",\"seven-powers\",\"blue-ocean-strategy\"],\"verify_with\":[\"epistemic-grounding\",\"methodology\",\"expected-value\"]}"
...
- Related: `positioning`, `swot-tows`, `pestel`, `porters-five-forces`, `playing-to-win`, `seven-powers`, `blue-ocean-strategy`, `expected-value`, `epistemic-grounding`, `methodology`
