...
metadata:
  ...
  relations: "{\"related\":[\"methodology\",\"no-cutting-corners\",\"best-practice\",\"epistemic-grounding\",\"evaluation\",\"prioritization\"],\"boundary\":[{\"skill\":\"no-cutting-corners\",\"reason\":\"no-cutting-corners owns the compact five-pillar pre-output ENFORCEMENT gate (the runnable checklist: split check, COMPLETE/PARTIAL/BLOCKED labels, done-evidence matrix, provenance tags, disclosure-redaction line); methodical owns the deep explanatory model of WHY completeness fails and the step-level execution architecture behind it. The sibling cross-references methodical as that model and lists methodical in verify_with — the two compose, gate over model.\"},{\"skill\":\"task-path-optimization\",\"reason\":\"task-path-optimization owns choosing or shortening the route through a task; methodical owns preserving complete evidence, counts, and verification while executing whatever route was chosen.\"},{\"skill\":\"best-practice\",\"reason\":\"best-practice owns broad artifact-quality standards; methodical owns complete and honest execution mechanics independent of artifact type.\"},{\"skill\":\"summarization\",\"reason\":\"summarization owns meaning-preserving compression after the source population is complete; methodical owns preventing premature compression, hidden exclusions, or item loss before summarization.\"},{\"skill\":\"context-management\",\"reason\":\"context-management owns what enters, stays in, or leaves the active working set; methodical owns making output claims and lists preserve the in-scope evidence honestly.\"},{\"skill\":\"evaluation\",\"reason\":\"evaluation owns scoring and verdict interpretation after an artifact exists; methodical owns the evidence discipline that makes a later score defensible.\"}],\"verify_with\":[\"best-practice\",\"epistemic-grounding\",\"evaluation\"]}"
...
- Owned by `summarization`: meaning-preserving compression after the source population is complete
- Owned by `context-management`: what enters, stays in, or leaves the active working set
- Owned by `evaluation`: scoring and verdict interpretation after an artifact exists

**Related skills**
- Verify with: `best-practice`, `epistemic-grounding`, `evaluation`
- Related: `methodology`, `no-cutting-corners`, `best-practice`, `epistemic-grounding`, `evaluation`, `prioritization`
