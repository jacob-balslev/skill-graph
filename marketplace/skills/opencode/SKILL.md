...
- Source repository: `https://github.com/anomalyco/opencode` (TypeScript core, MIT). The `--format json` exit-before-`step_finish` behavior is tracked in the project's upstream issues.
