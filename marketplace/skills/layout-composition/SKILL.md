...
metadata:
  relations: "{\"adjacent\":[\"information-architecture\",\"visual-design-foundations\",\"design-system-architecture\"],\"boundary\":[\"task-analysis\"]}"
  schema_version: "8"
  version: "1.0.0"
  subject: design
...
**Related skills**
- Related: `information-architecture`, `visual-design-foundations`, `design-system-architecture`
