...
metadata:
  relations: "{\"related\":[\"context-engineering\",\"prompt-craft\",\"tool-call-strategy\",\"context-management\",\"context-graph\"],\"suppresses\":[\"context-management\",\"context-graph\"],\"verify_with\":[\"context-management\"]}"
  subject: agent-ops
