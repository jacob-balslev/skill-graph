...
- Owned by `a11y`: labels, focus, fieldsets, errors, and assistive-tech behavior
- Owned by `microcopy`: validation-message wording
- Owned by `api-design`: submit endpoint schemas and error envelopes
- Owned by `data-modeling`: stored data shape
