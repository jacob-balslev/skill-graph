...
metadata:
  relations: "{\"related\":[\"code-review\",\"skill-scaffold\",\"pattern-recognition\",\"semantics\"],\"verify_with\":[\"code-review\",\"canonical-repo-structure\"]}"
...
**Related skills**
- Verify with: `code-review`, `canonical-repo-structure`
