...
metadata:
  relations: "{\"related\":[\"transaction-isolation\",\"entity-relationship-modeling\",\"database-migration\",\"indexing-strategy\",\"query-optimization\"],\"suppresses\":[\"database-migration\",\"indexing-strategy\"],\"verify_with\":[\"entity-relationship-modeling\",\"database-migration\"]}"
  ...
  skill_graph_canonical_description_length: "1596"
---
# Schema Evolution
...
- design a schema from scratch (use entity-relationship-modeling)
- diagnose a slow query (use query-optimization)
- choose shard keys or repartition data across nodes (use sharding-strategy)

**Related skills**
- Verify with: `entity-relationship-modeling`, `database-migration`
