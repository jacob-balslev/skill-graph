...
2. Read the protocol + the SINGLE-skill audit contract ONLY:
   ...
   - .opencode/commands/skill-audit-prompt-v2.2.md  → the per-skill audit contract (steps 1-8)
...
- `.opencode/commands/skill-audit-prompt-v2.2.md` — the per-skill audit contract this prompt drives.
