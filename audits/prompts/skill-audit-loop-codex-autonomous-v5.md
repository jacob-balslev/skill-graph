...
> Inner contract: `skill-graph/audits/prompts/skill-audit-loop-single-model.md` (v3) plus `.opencode/commands/skill-audit-prompt-v2.2.md`
...
| Model | `gpt-5.5` or current Codex-capable GPT model |
...
7. `/Users/jacobbalslev/Development/skill-graph/SKILL_METADATA_PROTOCOL.md`
...
11. `/Users/jacobbalslev/Development/.opencode/commands/skill-audit-prompt-v2.2.md`
...
- Per-skill v2.2 contract: `.opencode/commands/skill-audit-prompt-v2.2.md`
