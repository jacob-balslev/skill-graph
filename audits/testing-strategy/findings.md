...
ID: F1
Severity: P2
Surface: ../skills/skills/quality-assurance/testing-strategy/SKILL.md:1:1
...
- F2 [P2 warning]: boundary reason reads as deference ("microcopy owns functional UI text and contributor-facing writing; testing-strate…") — recommend ownership phrasing ("I own X over microcopy"). The boundary mechanic excludes the listed skill from co-routing when this skill wins; deference wording inverts the intent. See SKILL_METADATA_PROTOCOL.md § Relations § boundary WARNING.
