...
ID: F1
Severity: P2
Surface: ../skills/skills/product-domain/event-contract-design/SKILL.md:1:1
...
Evidence: Emitted by skill-lint.js — see ../skills/skills/product-domain/event-contract-design/SKILL.md line 1
