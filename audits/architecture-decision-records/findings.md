...
ID: F1
Severity: P2
Surface: ../skills/skills/code-engineering/architecture-decision-records/SKILL.md:1:1
...
Evidence: Emitted by skill-lint.js — see ../skills/skills/code-engineering/architecture-decision-records/SKILL.md line 1
