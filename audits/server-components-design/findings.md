...
ID: F1
Severity: P2
Surface: ../skills/skills/frontend-ui/server-components-design/SKILL.md:1:1
...
Evidence: Emitted by skill-lint.js — see ../skills/skills/frontend-ui/server-components-design/SKILL.md line 1
