...
Manual audit using `node scripts/skill-lint.js` (absolute path) + `node scripts/skill-graph-routing-eval.js` + body review against `docs/SKILL_AUDIT_CHECKLIST.md`.
