...
ID: F1
Severity: P2
Surface: ../skills/skills/product-domain/route-handler-design/SKILL.md:1:1
...
Evidence: Emitted by skill-lint.js — see ../skills/skills/product-domain/route-handler-design/SKILL.md line 1
Required action: Inspect the flagged line, correct the value, and re-run skill-lint.js.

ID: F2
Severity: P2
Surface: ../skills/skills/product-domain/route-handler-design/SKILL.md:75:3
Category: Schema validity
Problem: boundary reason reads as deference ("middleware runs once before route resolution and applies to many routes via a `m…") — recommend ownership phrasing ("I own X over middleware-patterns"). The boundary mechanic excludes the listed skill from co-routing when this skill wins; deference wording inverts the intent. See SKILL_METADATA_PROTOCOL.md § Relations § boundary WARNING.
Evidence: Emitted by skill-lint.js — see ../skills/skills/product-domain/route-handler-design/SKILL.md line 75
Required action: Inspect the flagged line, correct the value, and re-run skill-lint.js.
...
- F2 [P2 warning]: boundary reason reads as deference ("middleware runs once before route resolution and applies to many routes via a `m…") — recommend ownership phrasing ("I own X over middleware-patterns"). The boundary mechanic excludes the listed skill from co-routing when this skill wins; deference wording inverts the intent. See SKILL_METADATA_PROTOCOL.md § Relations § boundary WARNING.
