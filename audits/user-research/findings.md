...
ID: F1
Severity: P2
Surface: ../skills/skills/design-craft/user-research/SKILL.md:1:1
...
Evidence: Emitted by skill-lint.js — see ../skills/skills/design-craft/user-research/SKILL.md line 1
