...
// Certification + self-grading guard for the comprehension eval gate
// (evaluate-skill.js gate 8). Provides the family resolution and tier logic for
// the representative-generator + frontier-judge design. See docs/verdict-semantics.md
// and skill-graph/AGENTS.md § "Skill Audit Loop Model Policy".
//
// PASS — the only verdict that *certifies* a skill is useful — is
 ...
 *
 * A run earns the 'certifying' tier (the only tier from which PASS can
...
//
// A QUALITY JUDGE (comprehension grader, audit verdict, eval scoring)
...
// the COMPREHENSION_GRADER_MODEL env OVERRIDE was
