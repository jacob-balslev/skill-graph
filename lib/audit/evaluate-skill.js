...
// the path is resolved relative to __dirname — not REPO_ROOT/scripts/skill/graders,
// which does not exist in the skill-graph repo and made every standalone
// concept-eval run throw "Concept grader prompt not found". (SH-6304)
...
// skill.v7.schema.json enum requires UPPERCASE. We normalise at the write-back
// boundary so the grader internals stay unchanged.

/**
 * Valid application_verdict enum values per skill.v7.schema.json.
