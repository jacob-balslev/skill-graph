...
function runSkillAuditLoop(opts = {}) {
  ...
  if (!convergenceState.converged) {
    throw new Error(`skill-audit-loop: mandatory proposals did not converge for ${skill} after ${convergenceState.rounds} round(s) (${convergenceState.reason}); aborting before curate/apply.`);
  }
