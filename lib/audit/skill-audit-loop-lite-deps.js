...
function buildCuratePrompt({ skill, proposals, advisoryProposals = [], crossReview = [], currentSkillPath, mergedSkillPath, mergeLedgerPath, mergeProtocolRef, curatePassTemplate = '' }) {
...
function createSkillAuditLoopLiteDeps(options = {}) {
  ...
  function curate({ skill, skillDir, proposals, advisoryProposals = [], crossReview = [], currentSkillPath }) {
    ...
    try {
      const prompt = buildCuratePrompt({ skill, skillDir, proposals, advisoryProposals, crossReview, currentSkillPath, mergedSkillPath, mergeLedgerPath, mergeProtocolRef, curatePassTemplate: getCuratePassTemplate() });
