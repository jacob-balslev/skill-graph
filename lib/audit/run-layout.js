 ...
 * repos without coupling to one workspace's run-root. The workspace runtime adapter binds the
 * absolute root: as of 2026-06-07T that is `skill-graph/skill-audit-loop/progress/skill-audits`
 * (relocated from the historical `.opencode/progress/skill-audits` per the ADR-0016 surface #3
 * supersession). This module does not name or hardcode either path — the root is an argument.
 */
