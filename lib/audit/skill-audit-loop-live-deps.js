...
Output the COMPLETE curated SKILL.md as your ENTIRE reply. Start at the file's first character (the opening \`---\` frontmatter line) and stop at its last. The reply IS the document text and nothing else:
