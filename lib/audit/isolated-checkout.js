...
/**
 * Is the OS-level fence enforceable on this host? macOS only — Seatbelt's sandbox-exec
 * is the kernel primitive. Returns false (degrade to the in-process guard) elsewhere.
 * @returns {boolean}
 */
