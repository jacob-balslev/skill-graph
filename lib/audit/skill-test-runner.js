...
const { resolveSkillDirSpecifier } = require("./roots");
...
function findSkillDir(name) {
  const resolved = resolveSkillDirSpecifier(name, ROOT_DIR, null, { maxDepth: 8 });
  return resolved ? resolved.skillDir : null;
}
