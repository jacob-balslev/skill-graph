...
function renderPrompt({
  ...
  return [
    ...
    '- Apply the current Skill Metadata Protocol v7 contract (SKILL_METADATA_PROTOCOL.md + examples/skill-metadata-template.md):',
    '  - Core frontmatter MUST include: schema_version, name, description, version, type, category, scope, owner, freshness, drift_check, eval_artifacts, eval_state, routing_eval.',
    '  - Recommended routing and audit fields include triggers, keywords, relations, grounding (for codebase scope), comprehension_state with the five flat Understanding fields, and the v7 Health Block verdict fields when written by tooling.',
    '  - Do not resurrect deprecated fields such as eval_status, family, layer, primaryCategory, layerPrimary, or routingRole unless you are editing a historical compatibility fixture that intentionally contains them.',
    '  - Body MUST include sections: Coverage, Philosophy, Verification, and Do NOT Use When.',
    '  - Then follow the correct archetype contract for the skill: capability, workflow, router, or overlay. Do NOT force stale family-specific headings if they do not fit the real behavior of the skill.',
    '  - Description: 3rd person, trigger phrases, negative bounds, <=300 words.',
    '',
    'Editing rules:',
