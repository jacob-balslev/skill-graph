...
function renderPrompt({
  ...
  return [
    ...
    '  - Core frontmatter MUST include: name, description, subject (closed 12-enum browse shelf), deployment_target (closed 2-enum portable|project), scope (free-text PRD-style statement), and the other current template fields that match the skill. The audit-state sidecar owns schema_version and audit/eval verdict state.',
