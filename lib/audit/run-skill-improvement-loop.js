...
function renderPrompt({
  ...
  return [
    ...
    '  - Core frontmatter MUST include: name, description, version, type, scope, family, layer, primaryCategory, layerPrimary, routingRole, triggers, keywords, owner, freshness, eval_status, drift_check, relations.',
    ...
    '  - For new family choices, prefer: overlay, agent-ops, agent-cognition, agent-models, knowledge, skill-system, display, doctrine, workflow, framework, integration, security, data, umbrella.',
