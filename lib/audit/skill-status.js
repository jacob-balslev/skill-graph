...
function formatTable(skillName, healthBlock, skillContract = {}) {
  const lines = [];
...
function main() {
  ...
  process.stdout.write(formatTable(skillName, healthBlock, frontmatter));
}
...
module.exports = { extractHealthBlock, classifyAuditState, findSkillPath, findRepoRoot, formatTable };
