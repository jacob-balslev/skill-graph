...
const { collectSkillFiles, workspaceRoot } = require('../../scripts/lib/roots');
...
const {
  ...
  aggregateVerdict,
} = require('../../scripts/lib/audit-prompt-builder');
...
function readScopeFromSkill(skillFilePath) {
  try {
    const { parseFrontmatter } = require('../../scripts/lib/parse-frontmatter');
