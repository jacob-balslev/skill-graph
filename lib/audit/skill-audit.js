...
// DRIFT, BROKEN → BROKEN, else UNVERIFIED". The drift script currently emits
// "CLEAN" rather than the schema-enum "OK" (a drift-script vs schema enum
// mismatch surfaced by this work — separate finding); accept both as PASS.
