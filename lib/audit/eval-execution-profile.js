...
// Printify / Shopify / customer / bank / personal data). Encoded as
// `repoScope: 'skill-graph + skills ONLY'` and enforced by the cwd being the
// skill-graph repo, not the monorepo root. See memory
