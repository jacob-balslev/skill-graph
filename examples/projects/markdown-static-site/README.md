...
The Skill Graph contract features the specimens demonstrate (typed relations, grounding, drift detection, project tags, archetype discipline) work identically against any stack. A future specimen pack against a different stack would exercise the same contract; pick one whose worst-case mistake matches your risk tolerance.
