...
| **Get oriented in the audit loop** | [`skill-audit-loop/`](skill-audit-loop/) — folder front door (the loop, four operations, two gates, three verdicts) |
...
| [`evals/`](evals/) | Routing-eval baseline (`retrieval-baseline-v2.json`). Per-skill comprehension evals live alongside each skill or under `examples/evals/`. |
