...
> **Generated:** 2026-05-27T00:18:24.660Z
...
|---|---|---|---|
| check-markdown-links | ✅ PASS | 191 ms | OK   markdown links (296 file(s)) |
| check-protocol-consistency | ✅ PASS | 107 ms | PASS: all protocol consistency checks passed. 0 warning(s). |
...
| marketplace-export-check | ❌ FAIL | 145 ms | FAIL missing exported skill expected-value |
