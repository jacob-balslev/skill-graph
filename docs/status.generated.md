...
> **Generated:** 2026-05-27T00:04:14.938Z
...
|---|---|---|---|
| check-markdown-links | ✅ PASS | 237 ms | OK   markdown links (294 file(s)) |
| check-protocol-consistency | ✅ PASS | 114 ms | PASS: all protocol consistency checks passed. 0 warning(s). |
| check-doc-drift | ✅ PASS | 70 ms | OK   doc drift sentinel: 54 active doc(s) scanned against schema v8 |
...
| marketplace-export-check | ✅ PASS | 136 ms | PROJECTION TRUNCATED for writing-humanizer: tail truncated from 652 to 465 chars to fit 1024 limit |
