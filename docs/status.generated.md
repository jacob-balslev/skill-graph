...
> **Generated:** 2026-06-07T16:13:28.414Z
...
|---|---|---|---|
| check-markdown-links | ✅ PASS | 528 ms | OK   markdown links (1612 file(s)) |
| check-protocol-consistency | ✅ PASS | 117 ms | PASS: all protocol consistency checks passed. 0 warning(s). |
| check-doc-drift | ✅ PASS | 107 ms | OK   doc drift sentinel: 80 active doc(s) scanned against schema v8 |
...
| marketplace-export-check | ✅ PASS | 222 ms | PROJECTION TRUNCATED for writing-humanizer: tail truncated from 503 to 465 chars to fit 1024 limit |
