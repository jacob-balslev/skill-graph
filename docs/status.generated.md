...
> **Generated:** 2026-06-07T20:15:27.110Z
...
|---|---|---|---|
| check-markdown-links | ✅ PASS | 540 ms | OK   markdown links (1644 file(s)) |
| check-protocol-consistency | ✅ PASS | 117 ms | PASS: all protocol consistency checks passed. 0 warning(s). |
| check-doc-drift | ✅ PASS | 112 ms | OK   doc drift sentinel: 80 active doc(s) scanned against schema v8 |
| check-mirror-freeze | ✅ PASS | 52 ms | OK   mirror freeze: 20 file(s) scanned across 2 mirror(s); no active-source/package claims found. |
| marketplace-export-check | ✅ PASS | 226 ms | PROJECTION TRUNCATED for writing-humanizer: tail truncated from 503 to 465 chars to fit 1024 limit |
