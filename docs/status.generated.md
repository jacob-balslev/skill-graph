...
> **Generated:** 2026-05-28T17:43:57.787Z
...
|---|---|---|---|
| check-markdown-links | ✅ PASS | 205 ms | OK   markdown links (764 file(s)) |
| check-protocol-consistency | ✅ PASS | 120 ms | PASS: all protocol consistency checks passed. 0 warning(s). |
| check-doc-drift | ✅ PASS | 77 ms | OK   doc drift sentinel: 54 active doc(s) scanned against schema v8 |
...
| marketplace-export-check | ✅ PASS | 142 ms | PROJECTION TRUNCATED for writing-humanizer: tail truncated from 652 to 465 chars to fit 1024 limit |
