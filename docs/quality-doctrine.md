...
> **Applied to the audit loop:** [`docs/skill-audit-loop-philosophy.md`](skill-audit-loop-philosophy.md) is this doctrine's enforcement on the Skill Audit Loop — *improve = enrich, never strip to a delta; the eval is a guardrail, not the optimizer.*
