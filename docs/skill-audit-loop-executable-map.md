...
- `.opencode/commands/skill-audit-prompt-v2.2.md`, the active per-skill execution contract
- `.opencode/commands/skill-audit-loop.md`, the queue wrapper
- `prompts/audits/skill-audit-loop-single-model.md`, the cross-CLI per-skill prompt (v3)
