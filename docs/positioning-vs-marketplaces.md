...
> **Audience.** A working developer who has heard of Skill Graph and is mentally placing it on the AI-coding-context shelf alongside Cursor rules, Anthropic Agent Skills, GitHub Copilot custom instructions, AGENTS.md, skillsmp.com, and skills.sh. This document is a single-source reference for how Skill Graph relates to each. The README's [§ Where Skill Graph sits in the agent-skills landscape](../README.md#where-skill-graph-sits-in-the-agent-skills-landscape) is the short version; this is the long version.
>
> **Status.** Stable. Updated when a new context tool is named in the agent-skills landscape (open an issue if a tool is missing).
>
...
| **Per-runtime** | Cursor IDE specifically | Any agent runtime that supports Agent Skills |
...
- Anthropic Agent Skills: https://www.claude.com/skills
