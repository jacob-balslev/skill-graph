...
| 43e | `audit_verdict` | grouped under parent | `health.audit_verdict`. Compatibility read key retained by the manifest schema; current skill packages use the three verdict fields above. |
