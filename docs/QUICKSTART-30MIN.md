...
A project-anchored skill (`public: false` with a `project[]` reference) also needs a `grounding` block in `SKILL.md` frontmatter — point it at the real content schema and template post in your repo:
